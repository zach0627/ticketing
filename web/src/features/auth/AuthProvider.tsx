...
import { ApiError, setUnauthorizedHandler, tokenStore } from '../../shared/api/http';
import type { AuthResponse, UserDto } from '../../shared/api/types';
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const [isRestoring, setIsRestoring] = useState(() => tokenStore.read() !== null);
